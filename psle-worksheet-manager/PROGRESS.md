...
### Enhancements (GitHub Issues #4, #5, #15, #16)
...
### Completed
- [x] **Text search + pagination** ([#17](https://github.com/xiegu/psle-worksheet-manager/issues/17)) — Library: search-by-title input on both active tabs; QB: search-by-text/paper-title + 30-per-page pagination with Prev/Next on top and bottom
...
*Last updated: 2026-03-24 — resolved #17 (Library title search + QB search/pagination), #13 (shared _esc utility), #14 (duplicate score guard), #18 (undo + move-up/down), #19 (bulk operations), #20 (won't fix), #22 (focus preservation), #23 (QB caching), #24 (subject-aware titles)*
